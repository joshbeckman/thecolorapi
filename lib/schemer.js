...
exports.getScheme = function(mode, count, seed){
  var c = {
    ...
    seed: seed,
    image: {
      bare: 'http://www.thecolorapi.com/scheme?format=svg&named=false&hex=' + seed.hex.clean + '&mode=' + mode + '&count=' + count,
      named: 'http://www.thecolorapi.com/scheme?format=svg&hex=' + seed.hex.clean + '&mode=' + mode + '&count=' + count
    },
    _links:{
